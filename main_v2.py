...
from .config import STATIC_DIR, KEYPAIR_DIR, state, AUDIT_LOG_FILE, USERS_FILE
...
auth_service = AuthService(audit=audit_log, users_file=USERS_FILE)
...
async def startup_event():
    logger.info("ECS VM Security Assessment Console started (v1.2.0 with auth + registration)")
    ...
    audit_log.add("CONFIG_CHANGE", username="system", details="Application started v1.2.0")
